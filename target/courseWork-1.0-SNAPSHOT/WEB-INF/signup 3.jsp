        ...
        <div class="bg-contact2" style="background-image: url('../images/bg-02.jpg');">
            <div class="container-contact2">
                <div class="wrap-contact2">
                    <form method="post" action="${pageContext.request.contextPath}/tenders/signup" class="contact2-form validate-form">
                        ...
                        <div class="wrap-input2 validate-input" data-validate="Retype password">
                            <input class="input2" type="password" name="password2">
                            <span class="focus-input2" data-placeholder="RETYPE PASSWORD"></span>
                        </div>
